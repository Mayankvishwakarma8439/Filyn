...
const Card = ({ file }: { file: Models.Document }) => {
  ...
  return (
    <Link
      ...
      target="_blank"
      className="
    rounded-xl bg-white w-full md:w-[15vw] h-[22vh]  cursor-pointer shadow-[0_0_25px_rgba(0,0,0,0.08)] hover:shadow-[0_0_45px_rgba(0,0,0,0.15)] hover:scale-[1.03] transition-all duration-300"
    >
